...
export default class InformationsMois extends React.Component {
	...
	render(){
		...
		return(
			...
			<View>
				<Text style={style.titreO}> Informations sur le mois </Text>
				...
				<View style={{flexDirection: 'row', justifyContent: 'space-around', marginTop: 100}}>
					<View style={{flexDirection: 'column'}}>
						<Text style={{borderWidth: 2, paddingHorizontal: 30, paddingVertical: 35, backgroundColor: '#4B5C84', color: 'white', fontWeight: 'bold', fontSize: 20, textAlign: 'center'}}> 2.0 </Text>
				...
				<View style={{flexDirection: 'row', justifyContent: 'space-around', marginTop: 100}}>
					<View style={{flexDirection: 'column'}}>
						<Text style={{borderWidth: 2, paddingHorizontal: 30, paddingVertical: 35, backgroundColor: '#4B5C84', color: 'white', fontWeight: 'bold', fontSize: 20, textAlign: 'center'}}> 16.5 </Text>
						<Text style={{marginTop: 20, fontWeight: 'bold', textAlign: 'center'}}> Jours travaillés </Text>
					</View>
				</View>
			</View>
		);
