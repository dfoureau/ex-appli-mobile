let configurationAppli = {
  ...
  apiURL: "http://172.16.177.31/espacecollaborateur/rest/api/v1/web/app_dev.php/", // API TEST2 : http://172.16.177.31/espacecollaborateur/rest/api/v1/web/app_dev.php/
  lienMdpOublie:
